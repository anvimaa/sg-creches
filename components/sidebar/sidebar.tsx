...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-20 flex flex-col border-r bg-background transition-transform duration-300 ease-in-out",
          isOpen ? "translate-x-0" : "-translate-x-full",
          "lg:w-64 lg:translate-x-0",
          "w-full max-w-[256px]", // Define a largura máxima para mobile (igual a w-64)
          isOpen ? "max-lg:shadow-lg" : "", // Adiciona sombra quando aberto em mobile
          "lg:data-[open=true]:w-64 lg:data-[open=false]:w-[80px]"
        )}
        data-open={isOpen}
      >
        <div className={cn(
          ...
          {/* <Button
            variant="ghost"
            size="icon"
            className="lg:hidden absolute right-0 top-4 -mr-8"
            onClick={toggle}
          >
